...
namespace Parakeet.Net.Extensions
{
    ...
    public static class DomainServiceCollectionExtensions
    {
        ...
        {
            dbConnectionString = dbConnectionString.IsNullOrEmpty() ? services.GetConfiguration().GetConnectionString(CustomerConsts.ConnectionStringName) : dbConnectionString;
