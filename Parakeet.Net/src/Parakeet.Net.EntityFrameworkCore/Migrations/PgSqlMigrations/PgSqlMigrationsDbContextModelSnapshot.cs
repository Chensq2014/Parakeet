...
namespace Parakeet.Net.Migrations.PgSqlMigrations
{
    ...
    partial class PgSqlMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.TenantDbConnectionString", b =>
                {
                    ...
                    b.ToTable("parakeet_TenantDbConnectionStrings", "parakeet");
                });
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.AreaTenant", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.LocationArea", "LocationArea")
                        .WithMany()
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.Device", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.AreaTenant", "AreaTenant")
                        .WithMany("Devices")
                    ...
                    b.HasOne("Parakeet.Net.Entities.Project", "Project")
                        .WithMany("Devices")
                        .HasForeignKey("ProjectId");

                    b.HasOne("Parakeet.Net.Entities.Supplier", "Supplier")
                        .WithMany("Devices")
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Parakeet.Net.Entities.Threshold", "Threshold")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.DeviceAnalogRule", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.Device", "Device")
                        .WithMany()
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.DeviceMediator", b =>
                {
                    ...
                    b.HasOne("Parakeet.Net.Entities.Mediator", "Mediator")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.DeviceSequence", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.Device", "Device")
                        .WithOne("Sequence")
                        .HasForeignKey("Parakeet.Net.Entities.DeviceSequence", "DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.DeviceWorker", b =>
                {
                    ...
                    b.HasOne("Parakeet.Net.Entities.Worker", "Worker")
                        .WithMany("DeviceWorkers")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.House", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.Section", "Section")
                        .WithMany("Houses")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.LicenseResource", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.License", "License")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.LocationArea", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.LocationArea", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.Need", b =>
                {
                    b.OwnsOne("Parakeet.Net.ValueObjects.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.NeedAttachment", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.Need", "Need")
                        .WithMany("Attachments")
                        .HasForeignKey("NeedId");

                    b.OwnsOne("Parakeet.Net.ValueObjects.Attachment", "Attachment", b1 =>
                        {
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.Organization", b =>
                {
                    ...
                    b.HasOne("Parakeet.Net.Entities.Organization", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.OrganizationUser", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.Organization", "Organization")
                        .WithMany("Users")
                        .HasForeignKey("OrganizationId");
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.Product", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.House", "House")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.SectionWorker", b =>
                {
                    ...
                    b.HasOne("Parakeet.Net.Entities.WorkerType", "WorkType")
                        .WithMany()
            ...
            modelBuilder.Entity("Parakeet.Net.Entities.SectionWorkerDetail", b =>
                {
                    b.HasOne("Parakeet.Net.Entities.SectionWorker", "SectionWorker")
