    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AppId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true, comment: "AppId"),
                    AppKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true, comment: "AppKey"),
                    AppSecret = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true, comment: "AppSecret"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressCode = table.Column<string>(name: "Address_Code", type: "character varying(64)", maxLength: 64, nullable: true),
                    AddressZipCode = table.Column<string>(name: "Address_ZipCode", type: "character varying(64)", maxLength: 64, nullable: true),
                    AddressCountry = table.Column<string>(name: "Address_Country", type: "character varying(128)", maxLength: 128, nullable: true),
                    AddressProvince = table.Column<string>(name: "Address_Province", type: "character varying(128)", maxLength: 128, nullable: true),
                    AddressCity = table.Column<string>(name: "Address_City", type: "character varying(128)", maxLength: 128, nullable: true),
                    AddressArea = table.Column<string>(name: "Address_Area", type: "character varying(128)", maxLength: 128, nullable: true),
                    AddressStreet = table.Column<string>(name: "Address_Street", type: "character varying(255)", maxLength: 255, nullable: true),
                    AddressVillage = table.Column<string>(name: "Address_Village", type: "character varying(255)", maxLength: 255, nullable: true),
                    AddressDetail = table.Column<string>(name: "Address_Detail", type: "character varying(512)", maxLength: 512, nullable: true),
                    AddressFullName = table.Column<string>(name: "Address_FullName", type: "character varying(512)", maxLength: 512, nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Path = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true, comment: "如果类型为1=webApi，那么将匹配请求资源路由，支持正则表达式，如：^/api.*"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterId = table.Column<Guid>(type: "uuid", nullable: true),
                    DeletionTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AttachmentKey = table.Column<string>(name: "Attachment_Key", type: "character varying(128)", maxLength: 128, nullable: true),
                    AttachmentContent = table.Column<string>(name: "Attachment_Content", type: "text", nullable: true),
                    AttachmentBytes = table.Column<byte[]>(name: "Attachment_Bytes", type: "bytea", nullable: true),
                    AttachmentName = table.Column<string>(name: "Attachment_Name", type: "character varying(255)", maxLength: 255, nullable: true),
                    AttachmentExtention = table.Column<string>(name: "Attachment_Extention", type: "character varying(128)", maxLength: 128, nullable: true),
                    AttachmentSize = table.Column<decimal>(name: "Attachment_Size", type: "numeric", nullable: true),
                    AttachmentPath = table.Column<string>(name: "Attachment_Path", type: "character varying(255)", maxLength: 255, nullable: true),
                    AttachmentVirtualPath = table.Column<string>(name: "Attachment_VirtualPath", type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "parakeet_TenantDbConnectionStrings",
                schema: "parakeet",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_parakeet_TenantDbConnectionStrings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_parakeet_TenantDbConnectionStrings_parakeet_AreaTenants_Are~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_parakeet_TenantDbConnectionStrings_AreaTenantId",
                schema: "parakeet",
                table: "parakeet_TenantDbConnectionStrings",
                column: "AreaTenantId");
        }
