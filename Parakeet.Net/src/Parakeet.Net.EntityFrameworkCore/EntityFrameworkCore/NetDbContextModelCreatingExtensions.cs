...
namespace Parakeet.Net.EntityFrameworkCore
{
    ...
    public static class NetDbContextModelCreatingExtensions
    {
        ...
        private static void UniformNumberPrecision(ModelBuilder builder, [CanBeNull] IEnumerable<IMutableProperty> mutableProperties = null)
        {
            ...
            {
                property.SetColumnType(CustomerConsts.Decimal273); //非财务系统使用3位小数即可
        ...
        private static void PgSqlDateTimeFormat(ModelBuilder builder, [CanBeNull] IEnumerable<IMutableProperty> mutableProperties = null)
        {
            ...
            foreach (var property in properties)
            {
                property.SetColumnType(CustomerConsts.Timestamptz); //带时区
            }
            #endregion
        }
        ...
        private static void MapEntityComments(ModelBuilder builder, IEnumerable<PropertyInfo> properties = null)
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (property.PropertyType == typeof(decimal) || property.PropertyType == typeof(decimal?))
                {
                    ...
                    propotyBuilder.HasColumnType(CustomerConsts.Decimal273);
                }
                #endregion
        ...
        {
            b.Property<string>(nameof(AppUser.IdCardNo)).HasMaxLength(CustomerConsts.MaxLength18).HasComment("身份证号码");
            ...
            b.Property<string>(nameof(AppUser.SignAccountId)).HasMaxLength(CustomerConsts.MaxLength255).HasComment("签章的SignAccountId值");
            b.Property<string>(nameof(AppUser.Signature)).HasMaxLength(CustomerConsts.MaxLength8192).HasComment("个人签章照片-Base64");
            b.Property<string>(nameof(AppUser.Motto)).HasMaxLength(CustomerConsts.MaxLength255).HasComment("个性签名");
            b.Property<string>(nameof(AppUser.HeadPortraitKey)).HasMaxLength(CustomerConsts.MaxLength8192).HasComment("头像图片Key或Base64String");
