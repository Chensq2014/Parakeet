...
namespace ConsoleApp.Dtos.XiamenHuizhan
{
    ...
    public class SectionOneEnvironmentData
    {
        ...
        /// PM10
        /// </summary>
        [JsonProperty("PM10-Rtd"), JsonPropertyName("PM10-Rtd")]
        public decimal? Pm10Rtd { get; set; }

        /// <summary>
        /// PM10-Flag
        /// </summary>
        [JsonProperty("PM10-Flag"), JsonPropertyName("PM10-Flag")]
        public string Pm10Flag { get; set; }

        /// <summary>
        /// PM25
        /// </summary>
        [JsonProperty("PM25-Rtd"), JsonPropertyName("PM25-Rtd")]
        public decimal? Pm25Rtd { get; set; }

        /// <summary>
        /// PM25-Flag
        /// </summary>
        [JsonProperty("PM25-Flag"), JsonPropertyName("PM25-Flag")]
        public string Pm25Flag { get; set; }

        /// <summary>
        /// WS-Rtd 风速
        /// </summary>
        [JsonProperty("WS-Rtd"), JsonPropertyName("WS-Rtd")]
        public decimal? WsRtd { get; set; }

        /// <summary>
        /// WS-Flag
        /// </summary>
        [JsonProperty("WS-Flag"), JsonPropertyName("WS-Flag")]
        public string WsFlag { get; set; }

        /// <summary>
        /// DataTime
        /// </summary>
        [JsonProperty("DataTime"), JsonPropertyName("DataTime")]
        ...
        /// WdRtd 风向
        /// </summary>
        [JsonProperty("WD-Rtd"), JsonPropertyName("WD-Rtd")]
        public decimal? WdRtd { get; set; }

        /// <summary>
        /// WD-Flag
        /// </summary>
        [JsonProperty("WD-Flag"), JsonPropertyName("WD-Flag")]
        public string WdFlag { get; set; }

        /// <summary>
        /// PaRtd 压强
        /// </summary>
        [JsonProperty("PA-Rtd"), JsonPropertyName("PA-Rtd")]
        public decimal? PaRtd { get; set; }

        /// <summary>
        /// PA-Flag
        /// </summary>
        [JsonProperty("PA-Flag"), JsonPropertyName("PA-Flag")]
        public string PaFlag { get; set; }

        /// <summary>
        /// TEM-Rtd 温度
        /// </summary>
        [JsonProperty("TEM-Rtd"), JsonPropertyName("TEM-Rtd")]
        public decimal? TemRtd { get; set; }

        /// <summary>
        /// TEM-Flag
        /// </summary>
        [JsonProperty("TEM-Flag"), JsonPropertyName("TEM-Flag")]
        public string TemFlag { get; set; }

        /// <summary>
        /// TSP-Rtd 总悬浮颗粒物 
        /// </summary>
        [JsonProperty("TSP-Rtd"), JsonPropertyName("TSP-Rtd")]
        public decimal? TspRtd { get; set; }

        /// <summary>
        /// TSP-Flag
        /// </summary>
        [JsonProperty("TSP-Flag"), JsonPropertyName("TSP-Flag")]
        public string TspFlag { get; set; }

        /// <summary>
        /// B03-Rtd 噪音
        /// </summary>
        [JsonProperty("B03-Rtd"), JsonPropertyName("B03-Rtd")]
        public decimal? B03Rtd { get; set; }

        /// <summary>
        /// B03-Flag
        /// </summary>
        [JsonProperty("B03-Flag"), JsonPropertyName("B03-Flag")]
        public string B03Flag { get; set; }

        /// <summary>
        /// RH-Rtd 湿度
        /// </summary>
        [JsonProperty("RH-Rtd"), JsonPropertyName("RH-Rtd")]
        public decimal? RhRtd { get; set; }

        /// <summary>
        /// RH-Flag
        /// </summary>
        [JsonProperty("RH-Flag"), JsonPropertyName("RH-Flag")]
