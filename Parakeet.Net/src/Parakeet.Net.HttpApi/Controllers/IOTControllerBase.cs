...
//        {
//            await ProducerContainer.GetProducer(CustomerConsts.AppName, name).PublishAsync(buffer);
//        }
...
//        {
//            await ProducerContainer.GetProducer(CustomerConsts.AppName, name).PublishAsync(wrapperData, routingKey);
//        }
...
//        {
//            await ProducerContainer.GetProducer(CustomerConsts.AppName, name).PublishAsync(buffer, routeKey);
//        }
