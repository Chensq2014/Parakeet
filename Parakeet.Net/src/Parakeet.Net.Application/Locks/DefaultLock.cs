...
namespace Parakeet.Net.Locks
{
    ...
    public class DefaultLock: ILock
    {
        ...
        public async Task UnLockAsync()
        {
            ...
            //用remove事件去处理
            await EventBus.PublishAsync(new RemoveCacheEvent(CustomerConsts.UserLocker,_key));
        }
        ...
        public void UnLock()
        {
            ...
            //也可以使用remove事件去处理
            EventBus.PublishAsync(new RemoveCacheEvent(CustomerConsts.UserLocker,_key));
        }
