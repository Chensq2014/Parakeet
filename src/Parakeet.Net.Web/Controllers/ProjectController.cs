...
namespace Parakeet.Net.Controllers
{
    ...
    public class ProjectController : BaseNetEntityController<Project>
    {
        ...
        public IActionResult Map()
        {
            ...
            Response.Headers.Append("Content-Disposition", "inline; filename=" + encodeFilename);
        ...
        public virtual async Task<IActionResult> Tiku()
        {
            ...
            //文件名必须编码，否则会有特殊字符(如中文)无法在此下载。
            string encodeFilename = HttpUtility.UrlEncode(Path.GetFileName(filePath), Encoding.GetEncoding("UTF-8"));
            Response.Headers.Append("Content-Disposition", "attachment; filename=" + encodeFilename);
        ...
        public IActionResult Error()
        {
            ...
            Response.Headers.Append("content-disposition", "inline; filename=default.jpg");
