...
add-migration InitPortal -c TenantDbContext -o Migrations/TenantlMigrations
update-database -context TenantDbContext

add-migration InitDataProcess -c ProjectDbContext -o Migrations/ProjectMigrations
